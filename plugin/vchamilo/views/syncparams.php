...
if ($action){
    require_once($_configuration['root_sys'].'plugin/vchamilo/views/syncparams.controller.php');
}
...
foreach ($allparams as $param) {
    ...
    $data = array($check, $param->variable, $param->subkey, $param->category, $param->access_url, '<input type="text" name="value_'.$param->id.'" value="'.$param->selected_value.'" size="40" />', $syncthisbutton);
