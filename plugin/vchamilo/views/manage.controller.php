...
if ($action == 'newinstance') {
    ...
    vchamilo_redirect($_configuration['root_web'].'/plugin/vchamilo/views/editinstance.php?registeronly='.$registeronly);
}

if ($action == 'editinstance') {
    $vid = $_REQUEST['vid'];
    vchamilo_redirect($_configuration['root_web'].'/plugin/vchamilo/views/editinstance.php?id='.$vid);
}
