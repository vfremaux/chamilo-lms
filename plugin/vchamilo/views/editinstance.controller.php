...
require_once $_configuration['root_sys'].'main/inc/lib/fileManage.lib.php';

if (!defined('CHAMILO_INTERNAL')) die('You cannot use this script this way');

if ($data->what == 'addinstance') {
    ...
    */
    ...
    $sqls[] = " UPDATE {$settingstable} SET selected_value = '{$data->sitename}' WHERE variable = 'siteName' AND category = 'Platform' ";
    $sqls[] = " UPDATE {$settingstable} SET selected_value = '{$data->institution}' WHERE variable = 'institution' AND category = 'Platform' ";
    ...
    if (!$automation){
        echo '<a href="'.$_configuration['root_web'].'/plugin/vchamilo/views/manage.php'.'">Continue</a>';
        // vchamilo_redirect($_configuration['root_web'].'/plugin/vchamilo/views/manage.php');
        die;
    }
}
