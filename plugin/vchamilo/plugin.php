...
$form->addElement('static', 'enable_vchamilo_manager', '<a href="'.$wwwroot.'plugin/vchamilo/views/manage.php">'.$plugininstance->get_lang('manage_instances').'</a>');
$form->addElement('static', 'sync_vchamilo_settings', '<a href="'.$wwwroot.'plugin/vchamilo/views/syncparams.php">'.$plugininstance->get_lang('sync_settings').'</a>');
