...
class textlib {
    ...
    protected static function typo3($reset = false) {
        ...
        require_once('typo3/interface.t3lib_singleton.php');
        require_once('typo3/class.t3lib_l10n_locales.php');
        ...
        $GLOBALS['TYPO3_CONF_VARS']['BE']['folderCreateMask'] = decoct($_configuration['directorypermissions']);
        ...
        if (!defined('PATH_t3lib')) {
            define('PATH_t3lib', str_replace('\\','/',$_configuration['root_dir'].'local/ent_installer/typo3/'));
            define('PATH_typo3', str_replace('\\','/',$_configuration['root_dir'].'local/ent_installer/typo3/'));
            define('PATH_site', str_replace('\\','/',$_configuration['temp_dir'].'/'));
