...
function require_jqplot_libs() {
    ...
    // ent_installer_check_jquery(); // No need chamilo uses natively JQuery
    require_js('jqplot/jquery.jqplot.js', 'local_ent_installer', 'head');
    require_js('jqplot/excanvas.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.dateAxisRenderer.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.barRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.highlighter.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.canvasOverlay.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.cursor.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.categoryAxisRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.pointLabels.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.logAxisRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.canvasTextRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.canvasAxisTickRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.canvasAxisLabelRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.enhancedLegendRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.pieRenderer.min.js', 'local_ent_installer', 'head');
    require_js('jqplot/plugins/jqplot.donutRenderer.min.js', 'local_ent_installer', 'head');
    $jqplotloaded = true;
}
